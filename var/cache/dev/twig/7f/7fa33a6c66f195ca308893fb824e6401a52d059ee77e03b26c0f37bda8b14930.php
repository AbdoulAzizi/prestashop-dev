...
class __TwigTemplate_833d58693a00a85f571a4471c8f440e150f5b1949cc8ddb47c8fcb050103495c extends \Twig\Template
{
  ...
  ";
    ...
    ";
      ...
      <label for=\"";
        ...
        ";
                // line 277
                if (($this->getAttribute($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "vars", []), "label_attr", []) && $this->getAttribute($this->getAttribute($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "vars", []), "label_attr", []), "popover", [], "array"))) {
                    // line 278
                    echo "          ";
...
{% endmacro %}
", "@PrestaShop/Admin/macros.html.twig", "/var/www/html/prestashop/src/PrestaShopBundle/Resources/views/Admin/macros.html.twig");
    }
}
