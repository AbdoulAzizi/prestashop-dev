...
class SubscribeAlert extends ObjectModel
{
    public $id_customer;
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'created' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt', 'required' => true),
        ),
    );
    ...
    {
        $sql = '
            DELETE FROM `'._DB_PREFIX_.'crezzurcpn`
    ...
    public static function getSubscribeAlerts($id_customer, $id_lang, Shop $shop = null)
    {
    ...
    public static function getProducts($customer, $id_lang)
    {
        ...
        $sql = '
            ...
            FROM `'._DB_PREFIX_.'crezzurcpn` ma
    ...
    {
        $sql = '
            SELECT id_customer, customer_email, id_shop, id_lang FROM `'._DB_PREFIX_.'crezzurcpn`
